...
{
    public class SFDDLightSmokeAndMirrorsCardController : CardController
    {
        public SFDDLightSmokeAndMirrorsCardController(Card card, TurnTakerController turnTakerController)
