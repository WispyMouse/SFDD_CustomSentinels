...
{
    public class SFDDSerratedVinylSlashCardController : CardController
    {
        public SFDDSerratedVinylSlashCardController(Card card, TurnTakerController turnTakerController)
