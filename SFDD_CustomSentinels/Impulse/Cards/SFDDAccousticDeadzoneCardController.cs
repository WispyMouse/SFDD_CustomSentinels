...
{
    public class SFDDAccousticDeadzoneCardController : CardController
    {
        public SFDDAccousticDeadzoneCardController(Card card, TurnTakerController turnTakerController)
