...
{
    public class SFDDBuldUptotheDropCardController : CardController
    {
        public SFDDBuldUptotheDropCardController(Card card, TurnTakerController turnTakerController)
