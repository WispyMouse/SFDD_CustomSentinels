...
{
    public class SFDD200BeatdownsPerMinuteCardController : CardController
    {
        public SFDD200BeatdownsPerMinuteCardController(Card card, TurnTakerController turnTakerController)
