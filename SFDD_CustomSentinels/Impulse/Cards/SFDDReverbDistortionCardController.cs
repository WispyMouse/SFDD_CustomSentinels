...
{
    public class SFDDReverbDistortionCardController : CardController
    {
        public SFDDReverbDistortionCardController(Card card, TurnTakerController turnTakerController)
